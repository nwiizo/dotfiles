...
description: Rust初学者の構文・コードの読み方やコンパイルエラーを、型・所有権の動きと小さな例で説明する。つまずきに応じてコード追跡・想起・練習で理解と定着を支える。実装だけの依頼や専門家向けレビューでは説明を増やさない。
---
...
『プログラマー脳』を手がかりに、説明を読めることと、自力で予測・説明・修正できることを分けて扱う。
以下はRustの学習支援への応用方針であり、書籍の手順をそのまま再現するものではない。
