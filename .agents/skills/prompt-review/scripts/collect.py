...
使い方:
    ...
    python collect.py --project sample-project      # 特定プロジェクト
    python collect.py --project sample-project --days 30
"""
...
def collect_claude_code(cutoff_ms: int | None, project_filter: str | None) -> dict:
    ...
    if projects_dir.exists():
        for project_dir in projects_dir.iterdir():
            ...
            # 例: "c--Users-user-Documents-GitHub-sample-project" → 末尾部分を取得
