-- Navigation & Search plugins: snacks, telescope, oil, flash, overlook, hbac, persistence
return {
  -- persistence.nvim: Session management (auto-save/restore per directory)
  {
  ...
  -- Snacks.nvim: Modern utilities (picker, lazygit, bufdelete, terminal)
  {
    ...
    opts = {
      ...
      indent = { enabled = true }, -- Replace indent-blankline.nvim
      scroll = { enabled = true }, -- Smooth scrolling
      zen = { enabled = true }, -- Zen mode for focused editing
      rename = { enabled = true }, -- LSP rename with file rename support
